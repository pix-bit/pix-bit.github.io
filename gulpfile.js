...
gulp.task('watch', ['browser-sync'], function() { //, 'css', 'scripts'
...
gulp.task('clean', function() {
	return del.sync(['dist/*', '!dist/.git']); // Удаляем папку dist перед сборкой (кроме папки .git)
});
